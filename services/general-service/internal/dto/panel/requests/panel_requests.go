...
// PanelMemberInput is one named participant on a panel application.
type PanelMemberInput struct {
...
type CreatePanelRequest struct {
	...
	Members           []PanelMemberInput `json:"members" binding:"required,dive"`
}
...
type UpdatePanelRequest struct {
	...
	Members           *[]PanelMemberInput `json:"members" binding:"omitempty,dive"`
}
